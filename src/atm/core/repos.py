...
from atm.core.models import AgentIndex, RegisteredRepo, RuleIndex, SkillIndex
...
def add(
    ...
    *,
    ...
    _skills = importlib.import_module("atm.core.skills")
    _agents = importlib.import_module("atm.core.agents")
    _repo_rules = importlib.import_module("atm.core.repo_rules")
...
def _delete_agent_index(alias: str):  # type: ignore[no-untyped-def]
    ...
    from atm.core.models import AgentIndex as _AgentIndex
...
def _delete_rule_index(alias: str):  # type: ignore[no-untyped-def]
    ...
    from atm.core.models import RuleIndex as _RuleIndex
