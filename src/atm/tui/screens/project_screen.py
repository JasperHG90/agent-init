...
from atm.core import install as skill_install
from atm.core import rules as rules_mod
from atm.core.models import InstalledAgent, InstalledMcpServer, InstalledSkill
...
class ProjectScreen(Screen[None]):
    ...
    def _populate(self) -> None:
        ...
        if m is None:
            self._status("no .atm/manifest.json — run init from the main menu")
            return
