...
from atm.core import repos, rules, skills
...
def build_entries(app) -> list[PaletteEntry]:  # type: ignore[no-untyped-def]
    ...
    from atm.tui.screens.agents_screen import AgentsScreen
    ...
    from atm.tui.screens.mcp_screen import McpScreen
    ...
    from atm.tui.screens.rules_screen import RulesScreen
    from atm.tui.screens.skills_screen import SkillsScreen
