...
from atm.core import db, layout_profiles
from atm.core.hashing import hash_text
from atm.core.models import McpClaudeEntry, McpServerCache, McpServerVersion
...
def make_mcp_server_version(
    server: McpServer, entry: McpClaudeEntry | None = None
) -> McpServerVersion:
