...
from atm.core import default_mcp_servers, layout_profiles, mcp_registry
from atm.tui.modals.layout_profile_picker_modal import (
    LayoutProfilePickerModal,
)
from atm.tui.modals.palette import (
    PaletteEntry,
    PaletteModal,
    build_entries,
)
...
def run(project_root: Path | None = None, profile_name: str | None = None) -> None:
    AtmApp(project_root=project_root, profile_name=profile_name).run()
