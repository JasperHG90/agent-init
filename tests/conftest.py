"""Shared fixtures. The AIM_HOME env var redirects all platformdirs
...
def home(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Iterator[Path]:
    """Isolate all global aim state into tmp_path/home.
    ...
    monkeypatch.setenv("AIM_HOME", str(home_dir))
