...
from atm.core import agent_install as agent_install_mod
from atm.core import agents as agents_mod
from atm.core import agents_md as agents_md_mod
from atm.core import doctor as doctor_mod
from atm.core import format as format_mod
from atm.core import git
from atm.core import init as init_mod
from atm.core import install as install_mod
from atm.core import mcp_install as mcp_install_mod
from atm.core import mcp_registry as mcp_registry_mod
from atm.core import profiles as profiles_mod
from atm.core import repos as repos_mod
from atm.core import roots as roots_mod
from atm.core import rule_repos as rule_repos_mod
from atm.core import rules as rules_mod
from atm.core import skills as skills_mod
from atm.core import templates as templates_mod
...
from atm.core import manifest as manifest_mod  # noqa: E402
...
def main(
    ...
    """atm: scaffold and manage agent-engineering projects.
    ...
    if ctx.invoked_subcommand is None:
        ...
        from atm.tui.app import run as run_tui
...
def check_cmd(
    ...
    for proj in proj_list:
        try:
            from atm.core import agents_md, hashing, manifest
...
def init_cmd(
    ...
    """Initialize or refresh atm scaffolding in PROJECT."""
...
def rule_apply(
    ...
    """Low-level: copy rule body into a project's .atm/rules/ dir
