...
`init` seeds default-flagged rules into the project's `.atm/rules/` dir
...
from atm.core.models import RuleEntry
...
def get(name: str) -> Rule:
    ...
    from atm.core import rule_repos
...
def apply_to_project(
    ...
    if rules_dir is None:
        from atm.core.layout_profiles import resolve_active
...
def install_to_project(project_root: Path, name: str):  # type: ignore[no-untyped-def]
    ...
    get(name)
    from atm.core import init as _init
