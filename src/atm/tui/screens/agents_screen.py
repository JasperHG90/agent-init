...
from atm.core import agent_install as install_mod
from atm.core import agents, git, manifest, repos
from atm.tui.modals.agent_install import AgentInstallConfig, AgentInstallModal
from atm.tui.modals.agent_view import AgentViewModal
