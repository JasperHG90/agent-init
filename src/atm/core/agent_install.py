...
from atm.core import agents, hashing, layout_profiles, manifest, paths, validation
from atm.core.install import resolve_install_version
from atm.core.models import InstalledAgent, Manifest, SkillVersion
...
def _agent_index_row(qualified_name: str) -> agents.AgentIndex:
    from atm.core.models import AgentIndex
